...
namespace Desafio.Domain.Services.Entity.Imp
{
    public class FuncionarioEntityService : IFuncionarioEntityService
    {
        ...
        {
            string funcionariosArquivo = @"{ ""funcionarios"" :[
{
                ""matricula"": ""0009968"",
""nome"": ""Victor Wilson"",
""area"": ""Diretoria"",
...
""data_de_admissao"": ""2016-12-06""
            ...
            var xxx = Newtonsoft.Json.JsonConvert.DeserializeObject<Funcionarios>(funcionariosArquivo);
            return xxx.FuncionariosList;
        }
